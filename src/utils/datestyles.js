    ...
    calendar: {
        ...
        panel: ({ props }) => ({
            className: classNames('bg-white dark:bg-gray-900', 'min-w-full', {
                ...
                'inline-block overflow-x-auto border-gray-300 dark:border-blue-900/40 p-2 rounded-lg': props.inline
            })
        }),
        header: {
            className: classNames('flex items-center h-[35px] justify-between', ' text-gray-700 dark:text-white/80 bg-white dark:bg-gray-900 font-semibold m-0 border-b border-gray-300 dark:border-blue-900/40 rounded-t-lg')
        },
        previousButton: {
            className: classNames(
                'flex items-center justify-center cursor-pointer overflow-hidden relative',
                'w-2 h-8 text-gray-600 dark:text-white/70 border-0 bg-transparent rounded-full transition-colors duration-200 ease-in-out',
        ...
        monthTitle: {
            className: classNames('text-gray-700 dark:text-white/80 transition duration-200 font-semibold ', 'mr-2', 'hover:text-blue-500')
        },
        yearTitle: {
            className: classNames('text-gray-700 dark:text-white/80 transition duration-200 font-semibold ', 'hover:text-blue-500')
        },
        nextButton: {
            className: classNames(
                'flex items-center justify-center cursor-pointer overflow-hidden relative',
        ...
        dayLabel: ({ context }) => ({
            className: classNames(
                'w-[35px] h-[35px] rounded-[5px]  transition-shadow duration-200 border-transparent border',
                ...
                },
                {
                    ...
                    'text-white  hover:bg-blue-200 bg-green': context.selected && !context.disabled
                }
            )
        }),
        monthPicker: 'my-2',
