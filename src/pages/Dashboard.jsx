...
function Dashboard() {
  ...
  <section className="w-full flex flex-col gap-6 pt-[3%]">
    <ul className="grid grid-cols-responsive gap-4">
      ...
      <li className="h-60 w-full bg-white rounded-[10px] flex flex-col items-center justify-center overflow-hidden cursor-pointer group hover:scale-105 transition-transform duration-150">
        <img className="w-[80px] md:w-[100px]" src={Computer} alt="" />
        <span className="text-green text-sm">Enter Class Room</span>
      </li>

      <li className="h-60 w-full bg-[brown] rounded-[10px] flex flex-col items-center justify-center overflow-hidden cursor-pointer hover:scale-105 transition-transform duration-150">
